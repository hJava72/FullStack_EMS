          ...
          <div className="w-full max-w-md animate-fade-in text-center">
            ...
            <div className="mb-8">
                ...
                <p className='text-slate-500 text-sm 
                              sm:text-base mt-2'>{subtitle}</p>
            </div>

              {error && (
                  
                  <div className='mb-6 p-4 bg-rose-50 border-rose-200
                                 text-rose-700 text-sm rounded-xl flex item-start gap-3'>
                   ...
                   <label className='block text-sm font-medium text-slate-700 mb-2'>Password</label>
                     ...
                     <div className='relative'>
                        ...
                        <button type='button' className='absolute right-3 top-1/2 -translate-y-1/2
                                              text-slate-400 hover:text-slate-600 transition-colors' onClick={()=>
                    ...
                    <button type='submit' disabled={loading} className='w-full py-3 bg-gradient-to-r 
                            from-indigo-600 to-indigo-500 text-white rounded-lg text-sm font-semibold
                            ...
                            shadow-lg shadow-indigo-500/25 active:scale-[0.98] flex items-center justify-center'>
                              ...
                              {loading && <Loader2Icon className="animate-spin h-4 w-5 mr-2" />}
                              Sign In
